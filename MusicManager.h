...
public:
    ...
    static void DeleteTreeData(AVLTree<int,ThirdTreeNodeData*> *tree);

    static void DeleteData(TreeNode<int, ThirdTreeNodeData*> *root);
};
...
public:
    ...
    PlayCountNodeData() : plays(-1), singerTree(nullptr), smallest(nullptr) {}
